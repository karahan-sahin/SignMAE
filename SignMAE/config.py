...
# MODEL TYPE
POSE_ENCODER_TYPE = 'vivit' # VIVIT, VIDEOMAE
...
# LOGGING PARAMS
LOG_DIR = f'logs/signmae_base-{POSE_ENCODER_TYPE}-{TASK_TYPE}-{NUM_EPOCHS}-{BATCH_SIZE}-{TUBELET_SIZE}-{NUM_FRAMES}-{PATCH_SIZE}-logs.txt'